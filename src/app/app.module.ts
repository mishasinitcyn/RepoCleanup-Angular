...
import { GithubOutline, RadarChartOutline, FileMarkdownOutline, DownloadOutline, MinusOutline, SaveOutline, UserDeleteOutline, CloseOutline, SafetyOutline, TeamOutline, FileTextOutline, SendOutline, IssuesCloseOutline, BranchesOutline, YoutubeFill, MediumOutline} from '@ant-design/icons-angular/icons';
const icons = [GithubOutline, RadarChartOutline, FileMarkdownOutline, DownloadOutline, MinusOutline, SaveOutline, UserDeleteOutline, CloseOutline, SafetyOutline, TeamOutline, FileTextOutline, SendOutline, IssuesCloseOutline, BranchesOutline, YoutubeFill, MediumOutline];
